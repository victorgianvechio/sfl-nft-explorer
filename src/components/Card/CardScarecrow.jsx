import styles from './CardScarecrow.module.css';

import nftImg from '../../assets/scarecrow.png'
...
export function CardScarecrow(props) {
  return (
    <div className={styles.card}>
      ...
      <div className={styles.titleContainer}>
        <span className={styles.title}>Scarecrow</span>
      </div>
