import styles from './CardNugget.module.css';

import nftImg from '../../assets/nugget.png'
// import typeImg from '../../assets/level-up.png'
...
export function CardNugget(props) {
  return (
    <div className={styles.card}>
      ...
      <div className={styles.titleContainer}>
        <span className={styles.title}>Nugget</span>
      </div>
