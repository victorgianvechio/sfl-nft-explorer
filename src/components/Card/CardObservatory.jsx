import styles from './CardObservatory.module.css';

import nftImg from '../../assets/observatory.png'
...
export function CardObservatory(props) {
  return (
    <div className={styles.card}>
      ...
      <div className={styles.titleContainer}>
        <span className={styles.title}>Observatory</span>
      </div>
